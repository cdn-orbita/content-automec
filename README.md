# 📄 Descrição
Content Delivery Network (cdn) para Órbita Marketing Digital Ltda. servindo a Automec.
...
# ⚠️ Requisitos
> Conta autorizada para modificar o repositório local (content-vautomec). Contate um programador para lhe dar permissões.
> 
...
```
git init
git remote add origin https://github.com/cdn-orbita/content-automec.git
```
...
### 🔗 Link rápido:
```
https://cdn.jsdelivr.net/gh/cdn-orbita/content-automec/nome-da-imagem.ext
```
